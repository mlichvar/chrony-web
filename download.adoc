...
https://download.tuxfamily.org/chrony/chrony-4.4-pre1.tar.gz[chrony-4.4-pre1.tar.gz]
(https://download.tuxfamily.org/chrony/chrony-4.4-pre1-tar-gz-asc.txt[PGP signature])
