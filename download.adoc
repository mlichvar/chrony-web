...
https://chrony-project.org/releases/chrony-4.3.tar.gz[chrony-4.3.tar.gz]
(https://chrony-project.org/releases/chrony-4.3-tar-gz-asc.txt[PGP signature])

== Latest prerelease

https://chrony-project.org/releases/chrony-4.4-pre2.tar.gz[chrony-4.4-pre2.tar.gz]
(https://chrony-project.org/releases/chrony-4.4-pre2-tar-gz-asc.txt[PGP signature])
